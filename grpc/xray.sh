...
#
wget -q -O /usr/local/bin/geosite.dat "https://autoscript.caliphdev.com/grpc/menu/geosite.dat"
...
#
cd /usr/bin
wget -O addgrpc "https://autoscript.caliphdev.com/grpc/addgrpc.sh"
wget -O delgrpc "https://autoscript.caliphdev.com/grpc/delgrpc.sh"
wget -O renewgrpc "https://autoscript.caliphdev.com/grpc/renewgrpc.sh"
wget -O cekgrpc "https://autoscript.caliphdev.com/grpc/cekgrpc.sh"
